        ...
        <Grid.Row columns="5">
          <GridColumnStyled>
            <div className="ui segment">
              ...
              <Header as="h3">
                {metrics.visitors.day > 0 ? metrics.visitors.day.toFixed(2) : 0}
              </Header>
            </div>
          </GridColumnStyled>
          <GridColumnStyled>
            <div className="ui segment">
              ...
              <Header as="h3">
                {metrics.visitors.week > 0 ? metrics.visitors.week.toFixed(2) : 0}
              </Header>
            </div>
          </GridColumnStyled>
          <GridColumnStyled>
            <Segment>
              ...
              <Header as="h3">
                {metrics.visitors.month > 0 ? metrics.visitors.month.toFixed(2) : 0}
              </Header>
            </Segment>
          </GridColumnStyled>
